        ...
        <Navbar bg="light" expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto">
                    ...
                    {role === 'ROLE_CCADMIN' && <Nav.Link href="#" onClick={() => { history.push('/ccadmin/' + user.id) }}>Clinic center admin profile</Nav.Link>}
                    {role === 'ROLE_NURSE' && <Nav.Link href="#" onClick={() => { history.push('/nurse-page/' + user.id) }}>Nurse homepage</Nav.Link>}
                    {role === 'ROLE_ADMINC' && <Nav.Link href="#" onClick={() => { history.push('/adminc/' + user.id) }}>Clinic admin profile</Nav.Link>}
                    {role === 'ROLE_DOCTOR' && <Nav.Link href="#" onClick={() => { history.push('/doc/' + user.id) }}>Doctor homepage</Nav.Link>}
